...
import {
  profileSchema,
  softwareSkillsSchema,
  hardwareExperienceSchema,
  mlBackgroundSchema,
} from '../../src/onboarding/schemas/profile';
  ...
  describe('Full Profile Schema', () => {
    ...
    it('should reject profile with fewer than 3 sections', () => {
      ...
      if (result.success === false) {
        ...
        const hasThreeSectionError = result.error.issues.some(
          issue => issue.message.includes('complete at least 3 sections')
        );
